...
namespace BankAccountService.Application.Features.Transfers.Commands.Transfer.CardToDepositTranfer;

public class CardToDepositTransferCommandHandler : IRequestHandler<TransferCommand, Result<TransferResponse>>
{
    private readonly IUnitOfWorkWithRepositoriesFactory _unitOfWorkWithRepositoriesFactory;
    private readonly ICurrencyConversionService _conversionService;

    public CardToDepositTransferCommandHandler(
    ...
    public async Task<Result<TransferResponse>> Handle(TransferCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            DepositAccount toAccount = await unitOfWork
            ...
            await unitOfWork.DepositAccountRepository.UpdateAsync(toAccount).ConfigureAwait(false);
