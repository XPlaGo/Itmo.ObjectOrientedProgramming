...
{
    public SavingsAccountRepository(ApplicationDbContext dbContext, IEntityReader<SavingsAccount> entityReader)
    {
    ...
    public IEntityReader<SavingsAccount> EntityReader { get; }
    ...
    public async Task UpdateAsync(SavingsAccount entity)
    {
        ArgumentNullException.ThrowIfNull(entity);
    ...
    public async Task DeleteAsync(SavingsAccount entity)
    {
        ArgumentNullException.ThrowIfNull(entity);
